...
<div class="col-md-6 offset-md-3">
                    ...
                    <div class="card card-outline-secondary">
                        <div class="card-body">
                            <h3 class="text-center">VIP  subscription </h3>
                            <hr>
                            ...
                            <form class="form" role="form" autocomplete="off">
                                ...
                                <div class="form-group row">
                                        ...
                                        <button type="submit" class="btn btn-success btn-lg btn-block" name="submit">Pay 120₪ for VIP plan</button>
                                        <input type="hidden" name="Price3" value="<?php echo 120;?>">
                                        </form>
